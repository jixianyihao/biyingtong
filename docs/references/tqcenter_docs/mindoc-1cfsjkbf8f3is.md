...
> **Source**: https://help.tdx.com.cn/quant/docs/markdown/mindoc-1cfsjkbf8f3is/
> **Path**: `/docs/markdown/mindoc-1cfsjkbf8f3is/`
...
**请注意**：运行 TdxQuant 程序前，需预先启动支持TQ策略功能的 **通达信专业研究、量化模拟版或期货通等版本**。
