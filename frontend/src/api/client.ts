...
export const api = {
  ...
  t0StrategyProfiles: () =>
    request<T0StrategyProfilesResponse>('/api/t0/strategy-profiles'),
  t0Candidates: (body: T0CandidatesRequest) =>
    request<T0CandidatesResponse>('/api/t0/candidates', {
      method: 'POST',
      body: JSON.stringify(body),
    }),
  t0Portfolio: (body: T0PortfolioRequest) =>
    request<T0PortfolioResponse>('/api/t0/portfolio', {
      method: 'POST',
      body: JSON.stringify(body),
    }),
  t0Optimize: (body: T0OptimizeRequest) =>
    request<T0OptimizeResponse>('/api/t0/optimize', {
      method: 'POST',
      body: JSON.stringify(body),
    }),
};
